  ...
  <div class="order-right">
    <div class="order-content">
      ...
      <div class="orders">
        <table
          class="order-item"
          v-for="(orderInfo, index) in this.myOrder.records"
          :key="orderInfo.id"
        >
          <thead>
            <tr>
          ...
          <tbody>
            <tr
              v-for="(cart, index) in orderInfo.orderDetailList"
              :key="cart.id"
            >
              <td width="60%">
              ...
              <td
                :rowspan="orderInfo.orderDetailList.length"
                v-if="index == 0"
                width="8%"
                class="center"
              >
